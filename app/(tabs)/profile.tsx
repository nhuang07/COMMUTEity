...
const styles = StyleSheet.create({
  ...
  displayName: { fontSize: theme.fontSize.xl, fontFamily: theme.fontFamilyDisplay.bold, color: theme.colors.textPrimary, marginTop: theme.spacing.md, letterSpacing: -0.3 },
  email: { fontSize: theme.fontSize.sm, fontFamily: theme.fontFamily.normal, color: theme.colors.textSecondary, marginTop: theme.spacing.xs },
  ...
  detailLabel: { fontSize: theme.fontSize.sm, fontFamily: theme.fontFamily.medium, color: theme.colors.textSecondary },
  detailValue: { fontSize: theme.fontSize.sm, fontFamily: theme.fontFamily.semibold, color: theme.colors.textPrimary },
  socialText: { fontSize: theme.fontSize.sm, fontFamily: theme.fontFamily.normal, color: theme.colors.textPrimary, paddingVertical: theme.spacing.xs },
  noSocialsText: { fontSize: theme.fontSize.sm, fontFamily: theme.fontFamily.normal, color: theme.colors.textSecondary, fontStyle: "italic" },
